...
class PygameCanvas(Gtk.EventBox):
    ...
    def run_pygame(self, main_fn):
        # Run the main loop after a short delay.  The reason for
        # the delay is that the Sugar activity is not properly
    ...
    def _run_pygame_cb(self, main_fn):
        ...
        self._sceen = pygame.display.set_mode(
            (r.width, r.height), pygame.RESIZABLE)
